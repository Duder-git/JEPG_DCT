function [ Q ] = img_quantize1( tf, method, threshold)
%IMG_QUANTIZE Quantizes the image's transform
%
% Input:
%   tf     - a matrix of transform's coefficients
%   method - quantization method (
%            0: use the quantization matrix,
%            1: quantize by 'threshold', 
%            2: preserve 8 largest coefficients)
